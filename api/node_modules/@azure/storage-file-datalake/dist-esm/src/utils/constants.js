...
export var SDK_VERSION = "12.0.0-preview.8";
...
export var ToBlobEndpointHostMappings = [["dfs.core.windows.net", "blob.core.windows.net"]];
// Mapping pairs to transform url from blob endpoint to dfs endpoint
// Customize this value to add more mapping patterns
export var ToDfsEndpointHostMappings = [["blob.core.windows.net", "dfs.core.windows.net"]];
